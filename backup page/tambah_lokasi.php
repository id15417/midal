	...
	<div class="container">
		<div class="container mt-3">
            ...
            <hr />
				...
				<div class="row">
                    <div class="col">
                      <input type="text" class="form-control" placeholder="Lokasi/Ruangan" name="lokasi" required>
                    </div>
				</div>
				<br>
				<p>	
                    <a href="javascript:history.go(-1)" class="btn btn-danger btn-sm" role="button"><i class="fas fa-angle-left"></i> Kembali</a>
					<button type="submit" name="add_lokasi" class="btn btn-primary btn-sm">Simpan</button>
				</p> 
				</form>	
		</div>
    </div>
