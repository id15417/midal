        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="permintaan/rincianlaporan.php" class="dropdown-item"><i class="fas">&#xf56d;</i> Permintaan</a>
                  ...
                  <div class="row">
                    <div class="col-lg-4 col-6">
                      ...
                      <div class="small-box w3-blue">
                        ...
                        <a href="permintaan/permintaan.php" class="small-box-footer">More Info <i class="fas fa-arrow-right"></i></a>
                      </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-4 col-6">
                      ...
                      <div class="small-box w3-pink">
                        ...
                        <a href="pegawai/pegawai.php" class="small-box-footer">More info <i class="fas fa-arrow-right"></i></a>
                      </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-4 col-6">
                      ...
                      <div class="small-box w3-cyan">
                        ...
                        <a href="user/user.php" class="small-box-footer">More info <i class="fas fa-arrow-right"></i></a>
                      </div>
                    </div>
                    <!-- ./col -->
                  </div>
