                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="rincianlaporan.php" class="dropdown-item"><i class="fas">&#xf56d;</i> Permintaan</a>
                         <a href="dokumen.php" class="dropdown-item"><i class="fas fa-upload"></i> Upload Dokumen</a>
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="bidang.php" class="dropdown-item"><i class="far fa-circle"></i> Bidang</a>
                        <a href="user.php" class="dropdown-item"><i class="far fa-circle"></i> User</a>
                        <a href="pegawai.php" class="dropdown-item"><i class="far fa-circle"></i> Pegawai</a>
                        <a href="jenis.php" class="dropdown-item"><i class="far fa-circle"></i> MAK</a>
                    </div>
                </li>
                <li class="nav-item">
