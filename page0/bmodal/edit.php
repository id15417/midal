...
<div class="container" style="margin-top:80px">
	<div class="container">
			<div class="container mt-3">
				<h4>Belanja Modal &raquo; Ubah Belanja Modal</h4>
				<?php 
	              include 'proses.php';
	              $id 	 = $_GET['edit'];
	              $query = "SELECT * FROM belanja_modal
           					INNER JOIN pegawai    	 ON 
           					belanja_modal.id_pegawai 		= pegawai.id_pegawai
                          	INNER JOIN sub_bidang 	 ON 
                          	belanja_modal.id_sub_bidang 	= sub_bidang.id_sub_bidang
                          	INNER JOIN kat_perbaikan ON 
                          	belanja_modal.id_kat_perbaikan 	= kat_perbaikan.id_kat_perbaikan
					...
					<div class="card-body">
					    <form action="proses.php" method="POST">
							...
							<div class="row form-inline">
								...
								<input type="date" class="form-control" placeholder="Tanggal" name="tgl" value="<?php echo $data['tgl']; ?>" required>
							</div>
							<br>
					    	<div class="row form-inline">
